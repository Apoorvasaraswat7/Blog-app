...
function About() {
  ...
  return (
    <div className="container mx-auto my-12 p-4 space-y-9">
      ...
      <br />
      <span>
        Apoorva Saraswat is dedicated to leveraging his expertise to contribute to
      ...
      <p>
        ...
        holds immense admiration for <strong> Cristiano Ronaldo.</strong> His favorite
        person and biggest inspiration is his brother,{" "}
        <strong>Anand.</strong> Their friendly rivalry and deep bond have
